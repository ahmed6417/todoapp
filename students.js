...
let merge = tasksArray.flat(1);

var filteredArray = merge.filter(function(item, pos){
...
let studentsBody = document.querySelector (".students-body");
studentsBody.innerHTML = filteredArray;
